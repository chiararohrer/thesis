...
def prep(folder_name, sample_num, reduce_proteomics, letter, seed=None):
    ...
    merged_columns = ['f.eid'] + age[1:] + fasting[1:] + sex[1:] + assessment_centre[1:] + ethnic_bg[1:] + physical_measurments[1:] + smoking[1:] + alcohol[1:] + blood_count[1:] + blood_biochem[1:] + infect[1:] + metabolomics[1:] + urine[1:] + olink_batch_plate[1:] + olink_batch_well[1:]
