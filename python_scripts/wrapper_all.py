...
def run_all(folder, result_folder, interim_folder, id_file, output_folder, upper_cutoff=3650, letter=None, store_models=True, seed=None):
    ...
    print('len Disease names: ', len(disease_names), datetime.datetime.now(), flush=True)
    for disease in disease_names:
        if os.path.isfile(f'/mypath/diseases/icd10_filtered/filtered_{disease}.tsv'):
            print('starting ', disease, datetime.datetime.now(), flush=True)
